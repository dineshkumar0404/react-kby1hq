...
class RegisterForm extends React.Component {
  ...
  submituserRegistrationForm(e) {
    ...
    if (this.validateForm()) {
      ...
      // console.log(this.state.fields.employee_name);
      // console.log(this.state.fields.employee_salary);
      // console.log(this.state.fields.employee_age);
      // console.log(this.state.fields.email);
      // console.log(this.state.fields.designation);
